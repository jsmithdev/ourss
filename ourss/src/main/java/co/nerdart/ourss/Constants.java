...
public final class Constants {
    ...
    public static final String ACTION_REFRESH_FEEDS = "co.nerdart.ourss.REFRESH";
    public static final String ACTION_REFRESH_FINISHED = "co.nerdart.ourss.REFRESH_FINISHED";
    public static final String ACTION_MOBILIZE_FEEDS = "co.nerdart.ourss.MOBILIZE_FEEDS";
